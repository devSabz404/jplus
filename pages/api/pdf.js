...
export default function handler(req, res) {
   ...
   const registration = 'KDD696M'
   const make = 'Mazda'
   const model = 'CX5'
   const color = 'PEARL'
   const engine = 'PE 30614967'
   const chasis = 'KEEFW-113798'
   const seats = 5
   const cc =1990
   const year = 2014
  //const  value

  const companyName = `Iplus Insurance Agency Limited`
  const address = `PO BOX 29144 00100 GPO Equity Bank Building Third floor
  suite 202, Ring Road Roundabout, Ngara Rd, Nairobi`
  const phone = '+254 722 301 062'
  const email = 'info@iplus.co.ke'
const html = `
    ...
    let info = await transporter.sendMail({
      ...
      attachments: [
        ...
        {   // file on disk as an attachment
            filename: 'Jendie Incorporation 2022.pdf',
            path: '../../public/Jendie Incorporation 2022.pdf' // stream this file
        },
        {   // file on disk as an attachment
          filename: 'logbuk.pdf',
          path: '../../public/logbuk.pdf' // stream this file
      },
      {   // file on disk as an attachment
        filename: 'risknote.pdf',
        path: '../../public/risknote.pdf' // stream this file
    },
